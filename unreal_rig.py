'''
Author:- Tarun Rawlani(tarunrawlani111@gmail.com)
Script Name:- Rig Converter
Description:- This script to convert a sig rig to a rig that can be used in Unreal Engine 
'''
